<html>
<head>
<title>Update_Schedule1</title>

<script type="text/javascript">

function validatetxtbox()
{
  if(document.forms["coursescheduleform1"]["course_name1"].value == "none")
  {
    alert('Course cannot be left blank');
    return false;
  }
  if(document.forms["coursescheduleform1"]["secno1"].value == "none")
  {
    alert('SecNo cannot be left blank');
    return false;
  }
  if(document.forms["coursescheduleform1"]["semester1"].value == "none")
  {
    alert('Semester cannot be left blank');
    return false;
  }
  if(document.forms["coursescheduleform1"]["semester_year1"].value == "none")
  {
    alert('Semester year cannot be left blank');
    return false;
  }
  
  if(document.forms["coursescheduleform1"]["instructor_name1"].value == "none")
  {
...
<br/>
<br/>
<form onSubmit="return (validatetxtbox());" name ="coursescheduleform1" action="Update_display_next.php" method="POST">
<b>Please fill the fields and press submit to update the schedule</b>
<table>    
    <tr>      
        <td>Enter Course</td>        
        <td>
