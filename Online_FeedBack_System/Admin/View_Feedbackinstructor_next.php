<html>
<head>
  <title>Feedbacks By Instructor</title>
</head>
<body>
...
<?php
session_start();
$SInst_SSN = $_POST["instructor_name"];
...
$query = "select * from Instructor_Info,Course_Info,Course_Schedule where
          ...
          Course_Schedule.Inst_SSN = '$SInst_SSN' and Course_Schedule.Status='SUBMITTED' ";
$results = $db->query($query);

if ($results->num_rows == 0 ) 
{
	echo "<h4>There are no feedback(s) submitted by the instructor.</h4></br>";
}
else 
{
?>
    <h4>List of <?php echo $results->num_rows; ?> feedback(s) submitted by the instructor</h4>
    <table width="100%">
    <tr>
